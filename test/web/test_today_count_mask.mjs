// 无 billing.view 时 summary.today_settlements=null——入口必须显掩码,
...
// 点开右侧简表(renderTodaySimpleShell)同样要按 total===null 显掩码，
...
test("total=null(无权限) → 简表徽标显掩码、空态显无权限查看，不是 0/暂无数据", () => {
...
test("total=0(真的是0条,有权限) → 简表照常显0/暂无数据,不受掩码逻辑误伤", () => {
